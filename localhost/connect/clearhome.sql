...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 25 2025 г., 23:29
...
--
-- Дамп данных таблицы `cleaning_requests`
--

INSERT INTO `cleaning_requests` (`id`, `service_type`, `cleaning_type`, `area`, `estimated_price`, `name`, `phone`, `email`, `address`, `status`, `created_at`, `user_id`) VALUES
(1, NULL, NULL, NULL, NULL, 'Алексей', '79129323213', 'test@gmail.com', NULL, 'new', '2025-06-25 19:12:38', NULL),
(2, NULL, NULL, NULL, NULL, 'Алексей', '79321334243', 'test@gmail.com', NULL, 'new', '2025-06-25 19:44:21', NULL),
(3, NULL, NULL, NULL, NULL, 'Артем', '79031003344', 'test@mail.ru', NULL, 'new', '2025-06-25 19:46:39', NULL);
