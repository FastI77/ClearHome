...
<html lang="ru">
  ...
  <body>
    ...
    <main>
      ...
      <div class="reviews_container">
        ...
        <div class="read-all">
          <a href="#" onclick="showAllReviews(); return false;">Читать все отзывы</a>
          <a href="#" onclick="hideAllReviews(); return false;" class="hide-reviews" style="display: none;">Скрыть отзывы</a>
        </div>
      </div>
  ...
  <script>
    ...
    function showAllReviews() {
      ...
      document.querySelector(".read-all").style.display = "none";
    ...
    function displayReviews(page) {
        ...
        const reviewsToShow = isShowingAll ? reviews : reviews.slice((page - 1) * reviewsPerPage, page * reviewsPerPage);
      ...
      document.querySelector(".read-all").style.display = "block";
...
function hideAllReviews() {
    ...
    displayReviews(currentPage);
    setupPagination();
    document.querySelector(".read-all a").style.display = "inline";
    document.querySelector(".hide-reviews").style.display = "none";
}
...
function showAllReviews() {
  ...
  document.getElementById("pagination").style.display = "none";
  document.querySelector(".read-all a").style.display = "none";
  document.querySelector(".hide-reviews").style.display = "inline";
